...
- HostState         (host_state.py) workspaces/settings/presets — host-layer
                    capability re-exported here; the adapter only consumes it
...
from host_state import HostState  # host-layer state (workspaces/settings/presets)
...
# HostState now lives in host_state.py (host-layer capability, kept importable
# here so existing importers keep working): workspaces/settings/presets.
